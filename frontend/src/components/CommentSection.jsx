...
import { editComment } from "../../../backend/controllers/comment.controller.js";
...
function CommentSection({ postId }) {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-3">
      {currentUser ? (
        <div className="flex items-center gap-1 my-5 texgra500 text-sm">
          <p>Signed in as:</p>
          <img
        ...
        <div className="text-sm text-teal-500 dark:text-teal-400 my-5 flex gap-2">
